...
constract_id int auto_increment primary key,
constract_start_date datetime,
constract_end_date datetime,
constract_deposit double,
constract_total_money double,
employee_id int,
customer_id int,
service_id int,
...
quantity int,
foreign key (constract_id) references contract (constract_id),
